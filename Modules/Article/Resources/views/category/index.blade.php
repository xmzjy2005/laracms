                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group btn-space">
                                <a  class="btn btn-secondary" href="/article/category/{{$category['id']}}/edit">编辑</a>

                                <button type="button" class="btn btn-secondary" onclick="delCategory({{$category['id']}},this)">删除</button>
