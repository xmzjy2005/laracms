                ...
                <div class="card-body">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th>标题</th><th>作者</th><th>栏目</th><th>缩略图</th><th>查看次数</th><th>置顶</th>
                            <th>创建时间</th>
                            <th>修改时间</th>
                            <th>&nbsp;</th>
                        </tr>
                        ...
                        @foreach($data as $d)
                            <tr>
                                <td>{!! $d['id'] !!}</td>
                                <td>{!! $d['title'] !!}</td><td>{!! $d['author'] !!}</td><td>{{$d->category->name}}</td><td><img src='{!! $d['thumb'] !!}' style='width:45px;height:45px;'/></td><td>{!! $d['click'] !!}</td><td>{!! $d['istop'] !!}</td>
                                <td>{!! $d['created_at'] !!}</td>
                                <td>{!! $d['updated_at'] !!}</td>
                                <td class="text-right">
